...
class WebhookFailed extends Exception
{
    ...
    {
        return new static("Your bundle ID does not match bid in Apple's request", 400);
    }

    public static function nonValidReceipt($status)
    {
        $message = static::$receiptStatuses["$status"] ?? "Receipt was failed to validate";
